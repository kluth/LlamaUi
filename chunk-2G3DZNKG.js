...
_QuestionInputComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QuestionInputComponent, selectors: [["app-question-input"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 0, template: function QuestionInputComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "question-input works!");
    \u0275\u0275elementEnd();
  }
}, dependencies: [MatInputModule] });
var QuestionInputComponent = _QuestionInputComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QuestionInputComponent, { className: "QuestionInputComponent", filePath: "src/app/components/question-input/question-input.component.ts", lineNumber: 12 });
})();
export {
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-2G3DZNKG.js.map
