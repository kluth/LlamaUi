...
function withState(stateOrFactory) {
  return (store) => {
    const state2 = typeof stateOrFactory === "function" ? stateOrFactory() : stateOrFactory;
    const stateKeys = Object.keys(state2);
    store[STATE_SIGNAL].update((currentState) => __spreadValues(__spreadValues({}, currentState), state2));
...
var _ConversationService = class _ConversationService {
  constructor() {
  }
  fetchAnswer() {
    return of("Hello");
...
_ConversationService.\u0275fac = function ConversationService_Factory(t) {
  return new (t || _ConversationService)();
};
_ConversationService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ConversationService, factory: _ConversationService.\u0275fac, providedIn: "root" });
...
// src/app/stores/conversation.store.ts
var initialState = {
  question: "",
  preprompt: "",
  answer: "",
...
var ConversationStore = signalStore({ providedIn: "root" }, withState(initialState), withMethods((store, conversationService = inject(ConversationService)) => ({
  fetchAnswer: rxMethod(pipe(debounceTime(500), distinctUntilChanged(), tap(() => patchState(store, { isLoading: true })), switchMap(() => {
    return conversationService.fetchAnswer().pipe(tapResponse({
